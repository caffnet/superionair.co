...
<span class="firstLetter">T</span>he IT team sought out the top players in the Anti-Bot game. The arranged to setup a Proof Of Conecpt. Though, their executive leadership team decided against a PoC run by the vendors themselves. They prefered that all devices be baked off, in realtime - against identified bad traffic. The products selected were the following:

| Vendor               | Product          | Version |
|----------------------|------------------|---------|
| Imperva              | WAF              | 11.0    |
| F5                   | ASM              | 11.6    |
| Distil Networks      | Distil Appliance | NA      |



### Where we go from here
<span class="firstLetter">T</span>he next posts outline 
